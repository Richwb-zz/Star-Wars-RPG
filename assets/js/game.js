function CreateCharacter(name,image, health, attack, counter, weapons, agility){
	...
	var appendHtml = "<div id=" + id + " class=\"character start-position\"><img src=\"" + image + "\"><div class=\"characterStats\"><div>Name: <span class=\"name\">" + name + "</span></div><div>Health: <span id=\"" + id + "health\">" + health + "</span></div><div>Attack: <span id=\"" + id + "attack\">" + attack + "</span></div><div>Counter: <span id=\"" + id + "counter\">"+ counter + "</span></div><button id=\"" + id + "selectbtn\" class=\"visible select\"  data-character=\"" + id + "\" >Select</button><button id=\"" + id + "attackbtn\" class=\"invisible attack\"  data-character=\"" + id + "\">Attack</button><button id=\"" + id + "opponentbtn\" class=\"invisible opponent\" data-character=\"" + id + "\" >Opponent</button>";
